...
export default function ProjectsPage() {
  ...
  // Track when the project grid is scrolled past inline tabs
  useEffect(() => {
  ...
  const categories = ["all", "ai", "web", "algorithms", "software"] as const;
    ...
    categories.map((cat) => {
      ...
      return (
        ...
        >
          ...
          {t(`cat_${cat}`)}
          <span
            className={`ml-0.5 text-[10px] tabular-nums ${isActive ? "text-sky-400/60" : "text-slate-600"}`}
          >
            {count}
          </span>
        </button>
    ...
    <main className="relative min-h-screen overflow-x-clip">
      ...
      <div className="mx-auto max-w-5xl px-6 pt-28 pb-20">
        ...
        <div className="mb-10">
          ...
          <div className="flex items-center gap-4">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight">
              <span className="gradient-text">{t("all_projects")}</span>
            </h1>
        ...
        <section ref={sectionRef}>
          <div
            className={`flex items-center gap-2 overflow-x-auto no-scrollbar mb-8 transition-opacity duration-200 ${showFixedTabs ? "opacity-0 pointer-events-none" : "opacity-100"}`}
          >
            {renderTabs()}
          </div>
              ...
              >
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="flex flex-col justify-center p-6 md:w-1/2 md:p-8">
                    ...
                    <h4 className="text-xl md:text-2xl font-bold text-slate-50">
                      ...
                      <div className="mt-4 flex flex-wrap gap-1.5">
                        {featuredProject.technologies.map((tech: Technology, idx: number) => (
                          <span
                            ...
                            style={{
                              background: `linear-gradient(135deg, ${techColor(tech.name)}10, transparent)`,
                            }}
                          >
                            {tech.name}
                          </span>
            ...
            <AnimatePresence mode="popLayout">
              {remainingProjects.map((project: Project, i: number) => (
                ...
                >
                  ...
                  <h4 className="text-base font-semibold text-slate-100 mt-2">
                    {project.title}
                  </h4>
          ...
          <>
            ...
            >
              ...
              {expandedProject.technologies && (
                <div className="mt-5">
                  <p className="text-[10px] font-mono uppercase tracking-[0.2em] text-slate-600 mb-2.5">
                    Stack
                  </p>
